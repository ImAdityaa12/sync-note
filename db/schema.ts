 ...
 *
 * Note: per-document roles (Owner / Editor / Viewer) are an authorization
 * concern that belongs with the documents feature, not on the global user
 * record. They will be modelled as a `document_members` join table later.
 */
